        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card card-outline card-primary">
              ...
              <form class="card-tools ml-auto bd-highlight float-right" method="GET" action="/dashboard/tag">
                <input name="cari" type="text" class="form-control float-right" placeholder="Cari Tag"  />
